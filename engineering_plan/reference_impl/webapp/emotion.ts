// ASTR 情绪 → 环境光（设计的灵魂所在）
// 落点：拷贝到 webapp/src/lib/emotion.ts。规范：04_DESIGN_SYSTEM.md §3.2。
 ...
 */
export function applyEmotionGlow(v: EmotionVector, el: HTMLElement = document.documentElement): void {
