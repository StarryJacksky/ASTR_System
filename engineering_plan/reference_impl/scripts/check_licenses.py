...
PERMISSIVE = ("MIT", "BSD", "APACHE", "ISC", "PYTHON SOFTWARE", "PSF", "UNLICENSE",
              "ZLIB", "BOOST", "0BSD", "WTFPL", "PUBLIC DOMAIN")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--strict", action="store_true",
                    help="oisp-spec 仓用：任何 copyleft 都失败")
    ap.add_argument("--verify-notices", type=Path, default=None,
                    help="校验每个包都在该 NOTICES 文件里有记录")
    ...
    for name, lic, cat in rows:
        flag = {"strong-copyleft": "‼", "weak-copyleft": "▲", "unknown": "?", "permissive": " "}[cat]
