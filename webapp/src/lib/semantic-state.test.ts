...
describe("parallel semantic state", () => {
  ...
  it.each<{
    ...
    { event: { type: "STATUS_LOADING" }, region: "core", value: "loading" },
    { event: { type: "INGEST_STARTED" }, region: "conversation", value: "sending" },
    { event: { type: "INGEST_ACK" }, region: "conversation", value: "sending" },
    { event: { type: "INGEST_FAIL" }, region: "conversation", value: "error" },
    { event: { type: "REPLY_TIMEOUT" }, region: "conversation", value: "error" },
    { event: { type: "REPLY_SSE_CONNECTING" }, region: "replySse", value: "connecting" },
    { event: { type: "REPLY_SSE_OPEN" }, region: "replySse", value: "open" },
    { event: { type: "REPLY_SSE_ERROR" }, region: "replySse", value: "retrying" },
    { event: { type: "REPLY_SSE_CLOSED" }, region: "replySse", value: "closed" },
    { event: { type: "LIFE_SSE_CONNECTING" }, region: "lifeSse", value: "connecting" },
    { event: { type: "LIFE_SSE_OPEN" }, region: "lifeSse", value: "open" },
    { event: { type: "LIFE_SSE_ERROR" }, region: "lifeSse", value: "retrying" },
    { event: { type: "LIFE_SSE_CLOSED" }, region: "lifeSse", value: "closed" },
    ...
    {
      event: { type: "VISIBILITY_DERIVED", visibility: "hidden" },
      region: "visibility",
      value: "hidden",
    },
    {
      event: { type: "VISIBILITY_DERIVED", visibility: "offscreen" },
      region: "visibility",
      value: "offscreen",
    },
    {
      event: { type: "VISIBILITY_DERIVED", visibility: "visible" },
      region: "visibility",
      value: "visible",
    },
    ...
    { event: { type: "ESTOP_STATUS_CHECK" }, region: "safety", value: "stopUnknown" },
    { event: { type: "ESTOP_STATUS_CLEAR" }, region: "safety", value: "normal" },
    { event: { type: "ESTOP_STATUS_LATCHED" }, region: "safety", value: "stoppedLatched" },
    {
